...
const products = [
  ...
  { name: 'Security', description: 'Your customers’ datLink will be safe and secure', href: '#', icon: FingerPrintIcon },
    ...
    <header className="bg-slate-900">
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        ...
        <Popover.Group className="hidden lg:flex lg:gap-x-12">
          ...
          <Link href="/users" className="text-sm font-semibold leading-6 text-gray-100">
            Users
          </Link>
        </Popover.Group>
